...
/*we will delete the af code when the camera will not support the af 2013-7-30 for DELB-1157*/
#if 0
...
UINT32 S5K5EAYXYUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
	...
	case FID_ZOOM_FACTOR:
	     break; 
	case FID_AF_MODE:
/* delete if for the camera af  the camera will not support the af 2013-7-30 for DELB-1157*/
/*
...
UINT32 S5K5EAYXYUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0003); //REG_2TC_PCFG_uCaptureMirror    
		...
		S5K5EAYX_Preview_Mode_Setting(0);
    return TRUE;
}
/*we will delete the af  control registers 2013-7-30 for DELB-1157*/
# if 0
...
*/		     
		...
		case SENSOR_FEATURE_GET_SHUTTER_GAIN_AWB_GAIN:
		    ...
		    break;
/*we will delete  the  cmd for  the camera  nor support the af 2013-7-30 for DELB-1157*/
  #if 0
